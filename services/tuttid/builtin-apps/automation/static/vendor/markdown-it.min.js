...
!(function (t, e) {
  ...
  const G = /\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,
    W = new RegExp(G.source + "|" + /&([a-z#][a-z0-9]{1,31});/gi.source, "gi"),
    J = /^#((?:x[a-f0-9]{1,8}|[0-9]{1,8}))$/i;
  function Q(t, e) {
    if (35 === e.charCodeAt(0) && J.test(e)) {
      const r =
        "x" === e[1].toLowerCase()
  ...
  function ht(t) {
    let e = 0;
    for (; e < t.length && lt(t.charCodeAt(e)); e++);
    let r = t.length - 1;
    for (; r >= e && lt(t.charCodeAt(r)); r--);
    return t.slice(e, r + 1);
  }
  const pt = { mdurl: D, ucmicro: F };
  var ft = Object.freeze({
    ...
    isWhiteSpace: it,
    lib: pt,
    normalizeReference: at,
    unescapeAll: X,
    unescapeMd: function (t) {
      return t.indexOf("\\") < 0 ? t : t.replace(G, "$1");
    }
  });
  ...
  function zt(t) {
    ...
    for (let r = t.length - 1; r >= 0; r--) {
      const n = t[r];
      ("text" !== n.type || e || (n.content = n.content.replace(xt, vt)),
  ...
  function It(t, e) {
    ...
    for (let i = 0; i < t.length; i++) {
      ...
      t: for (; a < l; ) {
        ...
        const f = "'" === o[0];
        let d = 32;
        if (o.index - 1 >= 0) d = c.charCodeAt(o.index - 1);
        else
          for (
            r = i - 1;
        ...
        if (
          ...
          if (p)
            for (r = n.length - 1; r >= 0; r--) {
              ...
              if (t.single === f && n[r].level === u) {
                let u, c;
                ((t = n[r]),
                  f
                    ? ((u = e.md.options.quotes[2]),
                      (c = e.md.options.quotes[3]))
                    : ((u = e.md.options.quotes[0]),
                      (c = e.md.options.quotes[1])),
                  Lt(s, i, o.index, c),
                  Lt(s, t.token, t.pos, u),
                  (n.length = r));
                continue t;
              }
            }
          h
            ? n.push({ token: i, pos: o.index, single: f, level: u })
            : p && f && Lt(s, i, o.index, "\u2019");
        } else f && Lt(s, i, o.index, "\u2019");
      }
    }
    Object.keys(s).forEach(function (e) {
      t[e].content = (function (t, e) {
        let r = "",
          n = 0;
        e.sort((t, e) => t.pos - e.pos);
        for (let s = 0; s < e.length; s++) {
          const i = e[s];
          ((r += t.slice(n, i.pos) + i.ch), (n = i.pos + 1));
        }
        return r + t.slice(n);
      })(t[e].content, s[e]);
    });
    ...
    [
      ...
      function (t) {
        ...
        if (t.md.options.linkify)
          for (let r = 0, n = e.length; r < n; r++) {
            if ("inline" !== e[r].type || !t.md.linkify.pretest(e[r].content))
              continue;
            let n = e[r].children,
              s = 0;
            for (let i = n.length - 1; i >= 0; i--) {
              ...
              if ("link_close" !== o.type) {
                if (
                  ("html_inline" === o.type &&
                    (Et(o.content) && s > 0 && s--, At(o.content) && s++),
                  ...
                  e[r].children = n = U(n, i, c);
                }
              } else
                for (i--; n[i].level !== o.level && "link_open" !== n[i].type; )
                  i--;
            }
          }
      }
        ...
        if (t.md.options.typographer)
          for (e = t.tokens.length - 1; e >= 0; e--)
            "inline" === t.tokens[e].type &&
              (Ft.test(t.tokens[e].content) && zt(t.tokens[e].children),
              bt.test(t.tokens[e].content) && St(t.tokens[e].children));
      }
    ],
    [
      "smartquotes",
      function (t) {
        if (t.md.options.typographer)
          for (let e = t.tokens.length - 1; e >= 0; e--)
            "inline" === t.tokens[e].type &&
              qt.test(t.tokens[e].content) &&
              It(t.tokens[e].children, t);
      }
    ],
    [
      "text_join",
  ...
  ((Tt.prototype.process = function (t) {
    ...
    (Tt.prototype.State = Dt),
    (Rt.prototype.push = function (t, e, r) {
    ...
    (Rt.prototype.isEmpty = function (t) {
      return this.bMarks[t] + this.tShift[t] >= this.eMarks[t];
    }),
    (Rt.prototype.skipEmptyLines = function (t) {
      for (
        let e = this.lineMax;
  ...
  const Gt = [
    [
      ...
      function (t, e, r, n) {
        ...
        if (((c = Nt(t, e).trim()), -1 === c.indexOf("|"))) return !1;
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        for (t.parentType = "list"; c < r; ) {
          ...
          if (A) break;
          if (l) {
            if (((p = jt(t, c)), p < 0)) break;
            o = t.bMarks[c] + t.tShift[c];
          } else if (((p = Ot(t, c)), p < 0)) break;
    ...
    [
      ...
      function (t, e, r, n) {
        ...
        let o = t.src.slice(s, i),
          u = 0;
        for (; u < Vt.length && !Vt[u][0].test(o); u++);
        if (u === Vt.length) return !1;
        if (n) return Vt[u][2];
        let c = e + 1;
        const a = Vt[u][1].test("");
        if (!Vt[u][1].test(o))
          for (
            ;
            c < r && (!(t.sCount[c] < t.blkIndent) || (!a && t.isEmpty(c)));
            c++
          )
            if (
        ...
        t.line = c;
        const l = t.push("html_block", "", 0);
        return (
          (l.map = [e, c]),
          (l.content = t.getLines(e, c, t.blkIndent, !0)),
          !0
        );
      },
      ["paragraph", "reference", "blockquote"]
    ...
    [
      ...
      function (t, e, r) {
        ...
        if (!o) return ((t.parentType = s), !1);
        const c = ht(t.getLines(e, u, t.blkIndent, !1));
        t.line = u + 1;
    ...
    [
      ...
      function (t, e, r) {
        ...
        const o = ht(t.getLines(e, i, t.blkIndent, !1));
  ...
  function Wt() {
    ...
    for (let t = 0; t < Gt.length; t++)
      this.ruler.push(Gt[t][0], Gt[t][1], { alt: (Gt[t][2] || []).slice() });
  }
  function Jt(t, e, r, n) {
    ((this.src = t),
      (this.env = r),
  ...
  ((Wt.prototype.tokenize = function (t, e, r) {
    ...
    (Jt.prototype.push = function (t, e, r) {
    ...
    (Jt.prototype.scanDelims = function (t, e) {
      const r = this.posMax,
        n = this.src.charCodeAt(t);
      let s;
      if (0 === t) s = 32;
      else if (1 === t)
        ((s = this.src.charCodeAt(0)), 55296 == (63488 & s) && (s = 65533));
      else if (((s = this.src.charCodeAt(t - 1)), 56320 == (64512 & s))) {
        const e = this.src.charCodeAt(t - 2);
        s =
          55296 == (64512 & e)
            ? 65536 + ((e - 55296) << 10) + (s - 56320)
            : 65533;
      } else 55296 == (64512 & s) && (s = 65533);
      let i = t;
      for (; i < r && this.src.charCodeAt(i) === n; ) i++;
      const o = i - t;
      let u = i < r ? this.src.charCodeAt(i) : 32;
      if (55296 == (64512 & u)) {
        const t = this.src.charCodeAt(i + 1);
        u =
          56320 == (64512 & t)
            ? 65536 + ((u - 55296) << 10) + (t - 56320)
            : 65533;
      } else 56320 == (64512 & u) && (u = 65533);
      const c = ct(s) || ut(s),
        a = ct(u) || ut(u),
        l = it(s),
        h = it(u),
    ...
    (Jt.prototype.Token = kt));
  const Xt = /(?:^|[^a-z0-9.+-])([a-z][a-z0-9.+-]*)$/i;
  const Yt = [];
  for (let t = 0; t < 256; t++) Yt.push(0);
  function Kt(t, e) {
    let r;
    const n = [],
      s = e.length;
  ...
  var te = {
    ...
    postProcess: function (t) {
      ...
      Kt(t, t.delimiters);
      for (let n = 0; n < r; n++)
        e[n] && e[n].delimiters && Kt(t, e[n].delimiters);
    }
  };
  function ee(t, e) {
  ...
  var re = {
    ...
    postProcess: function (t) {
      ...
      ee(t, t.delimiters);
      for (let n = 0; n < r; n++)
        e[n] && e[n].delimiters && ee(t, e[n].delimiters);
    }
  };
  const ne =
      /^([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)$/,
    se = /^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^<>\x00-\x20]*)$/;
  const ie = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
    oe = /^&([a-z][a-z0-9]{1,31});/i;
  function ue(t) {
    const e = {},
      r = t.length;
    if (!r) return;
  ...
  const ce = [
      [
        ...
        function (t, e) {
          let r = t.pos;
          for (; r < t.posMax && !Qt(t.src.charCodeAt(r)); ) r++;
          return (
            r !== t.pos &&
      ...
      [
        ...
        function (t, e) {
          ...
          if (!e) {
            ...
            (s < 256 && 0 !== Yt[s] ? (e.content = i) : (e.content = o),
              (e.markup = o),
              (e.info = "escape"));
          }
          return ((t.pos = r + 1), !0);
      ...
      ["strikethrough", te.tokenize],
      ["emphasis", re.tokenize],
      [
        "link",
        function (t, e) {
          let r,
      ...
      [
        ...
        function (t, e) {
          ...
          if (
            ...
            return !1;
          const i = t.src.slice(n).match(Ut);
          if (!i) return !1;
          if (!e) {
      ...
      [
        ...
        function (t, e) {
          ...
          if (35 === t.src.charCodeAt(r + 1)) {
            ...
            const n = t.src.slice(r).match(oe);
            if (n) {
              const r = ((s = n[0]), O(s, L.Strict));
              if (r !== n[0]) {
                if (!e) {
                  const e = t.push("text_special", "", 0);
    ...
    ae = [
      [
        ...
        function (t) {
          ...
          ue(t.delimiters);
          for (let t = 0; t < r; t++)
            e[t] && e[t].delimiters && ue(e[t].delimiters);
        }
      ],
      ["strikethrough", te.postProcess],
      ["emphasis", re.postProcess],
      [
        "fragments_join",
        function (t) {
          let e,
  ...
  function le() {
    this.ruler = new gt();
    for (let t = 0; t < ce.length; t++) this.ruler.push(ce[t][0], ce[t][1]);
    this.ruler2 = new gt();
    for (let t = 0; t < ae.length; t++) this.ruler2.push(ae[t][0], ae[t][1]);
  }
  function he(t) {
    return (
      Array.prototype.slice.call(arguments, 1).forEach(function (e) {
  ...
  function fe(t) {
    return "[object Function]" === pe(t);
  }
  function de(t) {
    return t.replace(/[.?*+^$[\]\\(){}|-]/g, "\\$&");
  }
  ((le.prototype.skipToken = function (t) {
    const e = t.pos,
    ...
    (le.prototype.tokenize = function (t) {
      const e = this.ruler.getRules(""),
        r = e.length,
        n = t.posMax,
        s = t.md.options.maxNesting;
    ...
    (le.prototype.parse = function (t, e, r, n) {
      const s = new this.State(t, e, r, n);
      this.tokenize(s);
    ...
    (le.prototype.State = Jt));
  const _e = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 };
  const me = {
      "http:": {
  ...
  function ke(t) {
    ...
    ((t.__compiled__ = {}),
      Object.keys(t.__schemas__).forEach(function (e) {
        ...
        if (((t.__compiled__[e] = n), "[object Object]" === pe(r)))
          return (
            !(function (t) {
              return "[object RegExp]" === pe(t);
            })(r.validate)
              ? fe(r.validate)
  ...
  function ye(t, e) {
    ...
    (e ||
      ...
      Object.keys(r || {}).reduce(function (t, e) {
        return t || _e.hasOwnProperty(e);
      }, !1) && ((e = t), (t = {}))),
      (this.__opts__ = he({}, _e, e)),
      (this.__index__ = -1),
      (this.__last_index__ = -1),
      (this.__schema__ = ""),
      (this.__text_cache__ = ""),
      (this.__schemas__ = he({}, me, t)),
      (this.__compiled__ = {}),
      (this.__tlds__ = ge),
  ...
  ((ye.prototype.add = function (t, e) {
    return ((this.__schemas__[t] = e), ke(this), this);
  }),
    ...
    (ye.prototype.testSchemaAt = function (t, e, r) {
    ...
    (ye.prototype.match = function (t) {
      ...
      this.__index__ >= 0 &&
        ...
        (e.push(Ce(this, r)), (r = this.__last_index__));
      let n = r ? t.slice(r) : t;
      for (; this.test(n); )
        (e.push(Ce(this, r)),
    ...
    (ye.prototype.tlds = function (t, e) {
      return (
  ...
  const Le = function (t) {
    ...
    Me = function (t, e, r) {
      let n = 0;
      for (t = r ? ve(t / 700) : t >> 1, t += ve(t / e); t > 455; n += Ae)
        t = ve(t / 35);
      return ve(n + (36 * t) / (t + 38));
    },
    Te = function (t) {
      const e = [],
        r = t.length;
      ...
      o < 0 && (o = 0);
      for (let r = 0; r < o; ++r)
        (t.charCodeAt(r) >= 128 && Se("not-basic"), e.push(t.charCodeAt(r)));
      for (let u = o > 0 ? o + 1 : 0; u < r; ) {
        const o = n;
        for (let e = 1, s = Ae; ; s += Ae) {
          u >= r && Se("invalid-input");
          const o = Le(t.charCodeAt(u++));
          (o >= Ae && Se("invalid-input"),
            o > ve((Ee - n) / e) && Se("overflow"),
            (n += o * e));
          const c = s <= i ? 1 : s >= i + 26 ? 26 : s - i;
          if (o < c) break;
          const a = Ae - c;
          (e > ve(Ee / a) && Se("overflow"), (e *= a));
        }
        const c = e.length + 1;
        ((i = Me(n - o, c, 0 == o)),
          ve(n / c) > Ee - s && Se("overflow"),
          (s += ve(n / c)),
          (n %= c),
          e.splice(n++, 0, s));
      }
    ...
    Re = function (t) {
      ...
      let n = 128,
        s = 0,
        i = 72;
      for (const r of t) r < 128 && e.push(ze(r));
      const o = e.length;
      let u = o;
      for (o && e.push("-"); u < r; ) {
        let r = Ee;
        ...
        const c = u + 1;
        (r - n > ve((Ee - s) / c) && Se("overflow"),
          (s += (r - n) * c),
          (n = r));
        for (const r of t)
          if ((r < n && ++s > Ee && Se("overflow"), r === n)) {
            let t = s;
            for (let r = Ae; ; r += Ae) {
              ...
              const s = t - n,
                o = Ae - n;
              (e.push(ze(Ie(n + (s % o), 0))), (t = ve(s / o)));
            }
            (e.push(ze(Ie(t, 0))), (i = Me(s, c, u === o)), (s = 0), ++u);
          }
        (++s, ++n);
      }
      return e.join("");
    ...
    Ne = function (t) {
      return qe(t, function (t) {
        return Fe.test(t) ? "xn--" + Re(t) : t;
      });
    },
    Pe = function (t) {
      return qe(t, function (t) {
        return be.test(t) ? Te(t.slice(4).toLowerCase()) : t;
      });
    };
  const Oe = {
      default: {
    ...
    je = /^(vbscript|javascript|file|data):/,
    Ze = /^data:image\/(gif|png|jpeg|webp);/;
  function $e(t) {
    const e = t.trim().toLowerCase();
    return !je.test(e) || Ze.test(e);
  }
  const Ue = ["http:", "https:", "mailto:"];
  function He(t) {
    const e = g(t, !0);
    if (e.hostname && (!e.protocol || Ue.indexOf(e.protocol) >= 0))
      try {
        e.hostname = Ne(e.hostname);
      } catch (t) {}
    return n(s(e));
  }
  function Ve(t) {
    const r = g(t, !0);
    if (r.hostname && (!r.protocol || Ue.indexOf(r.protocol) >= 0))
      try {
        r.hostname = Pe(r.hostname);
      } catch (t) {}
  ...
  function Ge(t, e) {
    ...
    (e || j(t) || ((e = t || {}), (t = "default")),
      ...
      (this.linkify = new ye()),
      (this.validateLink = $e),
      (this.normalizeLink = He),
      (this.normalizeLinkText = Ve),
      (this.utils = ft),
      (this.helpers = $({}, dt)),
      (this.options = {}),
      this.configure(t),
  ...
  return (
    (Ge.prototype.set = function (t) {
      return ($(this.options, t), this);
    }),
    (Ge.prototype.configure = function (t) {
      const e = this;
      if (j(t)) {
        const e = t;
        if (!(t = Oe[e]))
    ...
    (Ge.prototype.render = function (t, e) {
      return (
        (e = e || {}),
        this.renderer.render(this.parse(t, e), this.options, e)
      );
    }),
    (Ge.prototype.parseInline = function (t, e) {
      const r = new this.core.State(t, this, e);
      return ((r.inlineMode = !0), this.core.process(r), r.tokens);
    }),
    (Ge.prototype.renderInline = function (t, e) {
      return (
        (e = e || {}),
